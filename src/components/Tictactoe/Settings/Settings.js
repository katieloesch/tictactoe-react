...
const Settings = ({ session, setSession, resetGame }) => {

    const handleMute = (e) => {

      if (session.mute) {
        sounds.soundOnSound.play();
      }
  ...
  return (
    <div className='settings flex'>
       ...
       <button className='btn' id='btn-mute' onClick={handleMute}>
        ...
        <button className="btn" id='btn-retrieve' onClick={handleRetrieve}>
        ...
        <button className="btn" id="btn-reset" onClick={handleResetGame}>
